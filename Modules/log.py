...
class logFile:
    ...
    def __init__(self, message):
        ...
        #if folder Logs not exist, create it
    ...
    def _logSimple(self): #Record the log in the file using a message
        with open(self.logfile,'a+') as f:
            f.write(f'Log:{self.message}\n')
        f.close()
...
def logSimple(message): #Public Function to Call in another Python file
    logFile(message).pubLogSimple()
